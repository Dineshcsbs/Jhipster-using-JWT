...
import static com.crud.domain.CompanyAsserts.*;
...
import com.crud.domain.Company;
...
class CompanyResourceIT {
    ...
    public static Company createEntity() {
        return new Company().name(DEFAULT_NAME).place(DEFAULT_PLACE).domain(DEFAULT_DOMAIN);
    }
    ...
    public static Company createUpdatedEntity() {
        return new Company().name(UPDATED_NAME).place(UPDATED_PLACE).domain(UPDATED_DOMAIN);
    }
    ...
    void putExistingCompany() throws Exception {
        ...
        updatedCompany.name(UPDATED_NAME).place(UPDATED_PLACE).domain(UPDATED_DOMAIN);
    ...
    void partialUpdateCompanyWithPatch() throws Exception {
        ...
        partialUpdatedCompany.place(UPDATED_PLACE);
    ...
    void fullUpdateCompanyWithPatch() throws Exception {
        ...
        partialUpdatedCompany.name(UPDATED_NAME).place(UPDATED_PLACE).domain(UPDATED_DOMAIN);
