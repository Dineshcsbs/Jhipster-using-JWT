...
import static com.crud.domain.EmployeeAsserts.*;
...
class EmployeeResourceIT {
    ...
    private static final Long DEFAULT_PANCARD = 1L;
    private static final Long UPDATED_PANCARD = 2L;
    ...
    public static Employee createEntity() {
        return new Employee().name(DEFAULT_NAME).age(DEFAULT_AGE).gender(DEFAULT_GENDER).pancard(DEFAULT_PANCARD);
    }
    ...
    public static Employee createUpdatedEntity() {
        return new Employee().name(UPDATED_NAME).age(UPDATED_AGE).gender(UPDATED_GENDER).pancard(UPDATED_PANCARD);
    }
    ...
    void getAllEmployees() throws Exception {
        ...
        restEmployeeMockMvc
            ...
            .andExpect(jsonPath("$.[*].pancard").value(hasItem(DEFAULT_PANCARD.intValue())));
    }
    ...
    void getEmployee() throws Exception {
        ...
        restEmployeeMockMvc
            ...
            .andExpect(jsonPath("$.pancard").value(DEFAULT_PANCARD.intValue()));
    }
    ...
    void putExistingEmployee() throws Exception {
        ...
        updatedEmployee.name(UPDATED_NAME).age(UPDATED_AGE).gender(UPDATED_GENDER).pancard(UPDATED_PANCARD);
    ...
    void partialUpdateEmployeeWithPatch() throws Exception {
        ...
        partialUpdatedEmployee.name(UPDATED_NAME).gender(UPDATED_GENDER).pancard(UPDATED_PANCARD);
    ...
    void fullUpdateEmployeeWithPatch() throws Exception {
        ...
        partialUpdatedEmployee.name(UPDATED_NAME).age(UPDATED_AGE).gender(UPDATED_GENDER).pancard(UPDATED_PANCARD);
